...
namespace RentMovie.Infrastructure.Migrations
{
    ...
    [Migration("20220425040107_InitialCreate")]
            ...
            modelBuilder.Entity("RentMovie.Application.Domain.Entities.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4e3bb825-e44c-441f-bf65-75934f8dda5b"),
                            AmountAvailable = 10,
                            ReleaseYear = 2022,
            ...
            modelBuilder.Entity("RentMovie.Application.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$jcTH2SqP6l2Zg4ycYymSy.BzVlKWtIMhMi.sCgX6w5IIHIZwG9VfO",
                            Role = 0,
                            ZipCode = "980395900"
                        },
                        new
                        {
                            ...
                            GivenName = "Admin User",
                            PasswordHash = "$2a$11$Dml4O83tKQS38fvjInWKsu6EggQqchHZ.Ef/3lNDkXvl6zKsXI3YS",
                            Role = 1,
                            ZipCode = "948019535"
                        });
                });
