...
namespace RentMovie.Infrastructure.Migrations
{
    ...
    [Migration("20220426035021_ModelUpdate")]
            ...
            modelBuilder.Entity("RentMovie.Application.Domain.Entities.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("117fceed-173c-460f-b746-a619bf6862c5"),
                            AmountAvailable = 10,
                            ReleaseYear = 2022,
            ...
            modelBuilder.Entity("RentMovie.Application.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "$2a$11$a2y7pmVo8jTLq0u6buVRqOUD5s65mFyW7kdzMl16eADPPe6pHxnra",
                            Role = 0,
                            ZipCode = "980395900"
                        },
                        new
                        {
                            ...
                            GivenName = "Admin User",
                            PasswordHash = "$2a$11$ycCqkfMk584VTmkWMybvrOTT16Dva46YCbj8OtRozjBaferedfUMG",
                            Role = 1,
                            ZipCode = "948019535"
                        });
                });
