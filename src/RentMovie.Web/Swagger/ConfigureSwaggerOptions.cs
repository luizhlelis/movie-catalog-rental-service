...
namespace RentMovie.Web.Swagger;
...
///     <see cref="IApiVersionDescriptionProvider" /> service has been resolved from the service
///     container.
/// </remarks>
public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
{
    ...
    /// </summary>
    /// <param name="provider">
    ///     The <see cref="IApiVersionDescriptionProvider">provider</see> used to
    ...
    {
        _openApiInfo.Version = description.ApiVersion.ToString();

        if (description.IsDeprecated)
        {
            _openApiInfo.Description += " This API version has been deprecated.";
        }
